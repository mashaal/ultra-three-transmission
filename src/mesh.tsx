...
type MeshTransmissionMaterialType =
  & Omit<JSX.IntrinsicElements["meshPhysicalMaterial"], "args">
  & {
...
type MeshTransmissionMaterialProps =
  & Omit<MeshTransmissionMaterialType, "resolution" | "args">
  & {
